...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="h-4 bg-gradient-to-b from-black/30 to-transparent shadow-lg">
      </div>
       ...
       <section className="py-12 md:py-20 mb-16">
         <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="w-full flex justify-center">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-16 max-w-7xl">
              {/* Video 1 */}
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                   whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.1 }}
                                       className="aspect-[9/16] bg-black rounded-lg md:rounded-xl lg:rounded-2xl overflow-hidden shadow-lg flex flex-col items-center justify-center max-w-48 md:max-w-56 lg:max-w-64 transform rotate-3 md:rotate-6 lg:rotate-12 -mt-8 md:-mt-10 lg:-mt-14 border-2 md:border-4 border-black"
              >
                <video
              ...
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                   whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                                       className="aspect-[9/16] bg-black rounded-lg md:rounded-xl lg:rounded-2xl overflow-hidden shadow-lg flex flex-col items-center justify-center max-w-48 md:max-w-56 lg:max-w-64 transform -rotate-3 md:-rotate-6 lg:-rotate-12 mt-6 md:mt-8 lg:mt-12 border-2 md:border-4 border-black"
              >
                <video
