          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto overflow-visible">
            {[
              ...
              >
                ...
                {/* Avatar at bottom */}
                <div className={`absolute -right-2 md:-right-4 w-16 h-16 md:w-20 md:h-20 lg:w-28 lg:h-28 flex items-center justify-center relative z-10 ${process.step === '01' ? '-bottom-28 md:-bottom-30' : process.step === '02' ? '-bottom-20 md:-bottom-8' : '-bottom-20 md:-bottom-8'}`}>
