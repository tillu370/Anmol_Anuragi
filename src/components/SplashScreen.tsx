    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden film-grain">
      ...
      <div className="relative z-10 text-center">
        ...
        >
          <div className="relative">
            <motion.div
              ...
              className="w-24 h-24 mx-auto border-2 border-white/30 rounded-full flex items-center justify-center"
            >
            ...
            <motion.div
              ...
              className="absolute inset-0 w-24 h-24 mx-auto border border-white rounded-full"
            />
          </div>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-bold text-white mb-4 cinzel"
        >
          Anmol Anuragi
        </motion.h1>
